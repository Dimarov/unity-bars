  ...
  <Background>
    <Header>
      <Container>
        ...
        <Title>CorpLight <Span>Oschadbank</Span></Title>
        <Subtitle>Internet banking for SMB and private clients</Subtitle>
        <ButtonContainer>
    ...
    <Container>
      <AboutContainer>
        ...
        <InfoContainer>
          <InfoTitle>Possibilites CorpLight</InfoTitle>
          <InfoElementContainer>
            <InfoElement>
              ...
              <InfoElementDescription>
                <InfoElementDescriptionTitle>Online banking</InfoElementDescriptionTitle>
                <InfoElementDescriptionText>Access to banking products and services wherever and whenever.</InfoElementDescriptionText>
              </InfoElementDescription>
            </InfoElement>
            <InfoElement>
              <InfoElementIcon>
              ...
              <InfoElementDescription>
                <InfoElementDescriptionTitle>Functionality</InfoElementDescriptionTitle>
                <InfoElementDescriptionText>Functionality that responsible for modern customer requirements.</InfoElementDescriptionText>
              </InfoElementDescription>
            </InfoElement>
            <InfoElement>
              <InfoElementIcon>
              ...
              <InfoElementDescription>
                <InfoElementDescriptionTitle>Design</InfoElementDescriptionTitle>
                <InfoElementDescriptionText>The design of the system is based on the user intuitive preferences. According to the standards of Material design Android and IOS Human Interface Guidelines.</InfoElementDescriptionText>
              </InfoElementDescription>
            </InfoElement>
          </InfoElementContainer>
        </InfoContainer>
