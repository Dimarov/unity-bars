  ...
  <StyledBackground>
    <StyledHeader>
      <Container>
        ...
        <StyledSubtitle>Свяжитесь с нами и узнайте, как мы можем помочь вашему бизнесу достичь высоких результатов
        </StyledSubtitle>
      </Container>
    </StyledHeader>
    <StyledGrid>
      <StyledContact>
        ...
        <StyledContactText>02152, г. Киев, проспект Павла Тычины, 1В, офис А</StyledContactText>
      ...
      <StyledContact>
        <StyledContactForm name="contact" method="POST" netlify-honeypot="bot-field" netlify>
          <StyledContactFormTitle>Отправить сообщение</StyledContactFormTitle>
          <StyledContactInput placeholder="Ваше имя" />
          <StyledContactInput placeholder="Ваш Email" />
          <StyledContactInput placeholder="Ваш Телефон" />
          <StyledContactTextarea placeholder="Ваше Сообщение" />
          <StyledContactSubmit type="submit" value="Отправить" />
        </StyledContactForm>
      </StyledContact>
    </StyledGrid>
  </StyledBackground>
