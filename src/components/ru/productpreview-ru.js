    ...
    <Background themeColor='#000'>
      <Content>
        ...
        <Info>
          ...
          <Subtitle themeColorSecondary='#FFF'>Интернет банкинг для МСБ и частных клиентов</Subtitle>
          <ButtonContainer>
          ...
          <MoreButton themeColorSecondary='#3EC4E1'>Больше</MoreButton>
        </Info>
      </Content>
    </Background>
    <Background themeColor='#FEFEFE'>
      <Content>
        <Info>
          ...
          <Subtitle themeColorSecondary='#303030'>Онлайн система управления банковскими счетами и продуктами</Subtitle>
          <ButtonContainer>
          ...
          <MoreButton to="/corplight" themeColorSecondary='#3EC4E1'>Больше</MoreButton>
        </Info>
        <ImageContainer>
    ...
    <Background themeColor='#FAFAFA'>
      <Content>
        ...
        <Info>
          ...
          <Subtitle themeColorSecondary='#29333E'>24/7 доступ к Вашим банковским сервисам</Subtitle>
          <ButtonContainer>
